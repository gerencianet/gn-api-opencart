...
$_['gn_config_saved'] = 'Suas configurações foram salvas com sucesso e agora você já pode receber pela Gerencianet!';
$_['gn_config_saved_not_on'] = 'Suas configurações foram salvas com sucesso, mas o seu módulo ainda não está ativo pois você não preencheu todos os campos obrigatórios ou não preencheu corretamente.<br>Verifique as informações: ';
...
$_['gn_entry_payment_notification_update'] = 'Atualizar status dos pedidos do OpenCart automaticamente';
$_['gn_entry_payment_notification_update_notify'] = 'Ao atualizar, enviar email da sua loja automaticamente notificando o cliente';
...
$_['gn_entry_billet_days_to_expire_placeholder'] = 'Digite o número de dias para vencimento do Boleto.';
...
$_['gn_entry_status_config_description'] = "Configure os Status de pagamento da Gerencianet com os Status de pagamento de sua loja. Assim, quando houver a alteração do status do pagamento na Gerencianet, automaticamente o status do pedido em sua loja será atualizado de acordo com as configurações definidas abaixo.";

$_['gn_entry_help_sandbox'] = "Esta configuração permite que você realize testes para gerar cobranças sem que esteja no ambiente de produção.";
$_['gn_entry_help_status'] = "Define se o módulo da Gerencianet estará disponível para o cliente.";
$_['gn_entry_help_billet_expire'] = "Você pode configurar quantos dias corridos para o boleto vencer após a data de geração.";
...
$_['gn_entry_help_keys'] = 'O par de chaves Client ID e Client Secret são informações sigilosas que identificam sua aplicação e permitem a realização do pagamento. Para obter suas chaves você precisa entrar em sua conta Gerencianet e criar uma <a href="https://docs.gerencianet.com.br/#!/api-keys/create" target="_blank">Nova Aplicação</a>. Você terá acesso a dois pares de chaves: um de Desenvolvimento e outro de Produção.';
$_['gn_entry_help_payee_code'] = 'O identificador da conta é uma chave única utilizada para identificar uma determinada conta. Você pode encontrá-lo no link API, acima do menu.';

$_['gn_entry_help_notification_update'] = "Você pode definir se o módulo pode alterar o status de um pedido automaticamente de acordo com a configuração da aba Status da Compra quando por exemplo o pagamento for confirmado";
$_['gn_entry_help_notification_update_notify'] = "Notifica o cliente através de um email da sua loja quando uma atualização do status automática for realizada. Independente da opção, a Gerencianet enviará um email para o cliente informando sobre a cobrança.";
$_['gn_entry_help_discount'] = "Você pode escolher dar um desconto para o cliente caso o mesma esteja realizando o pagamento por Boleto.";

$_['gn_entry_discount_title'] = 'Configurar descontos';
$_['gn_entry_discount_billet'] = 'Desconto para pagamento através de Boleto';
$_['gn_entry_discount_status'] = 'Status';
$_['gn_entry_discount_type'] = 'Tipo de desconto';
$_['gn_entry_discount_type_fixed'] = 'Valor fixo';
$_['gn_entry_discount_type_percent'] = 'Percentagem do valor dos produtos';
...
$_['gn_entry_no_payment_selected'] = 'É obrigatório pelo menos uma forma de pagamento';
