 ...
 */
class ModelExtensionPaymentGerencianetPix extends Model {
    ...
    public function insert($data){
        ...
        $this->db->query("INSERT INTO `{$this->getTableWithPrefix('gerencianetpix')}` 
    ...
    public function update($conditions, $dataToUpdate){
        ...
        $this->db->query("UPDATE `{$this->getTableWithPrefix('gerencianetpix')}` 
    ...
    public function find($column, $value){
        ...
        $arrayReturn = $this->db->query("SELECT * FROM `{$this->getTableWithPrefix('gerencianetpix')}` WHERE `{$column}` = '{$value}'");
